<!-- "single-(post type).php" is used to display individual posts from the named post type -->
<?php
    ...
    while(have_posts()) {
        ...
        <div class="container container--narrow page-section">
            <div class="metabox metabox--position-up metabox--with-home-link">
                <!-- 'get_post_type_archive_link();' outputs a link to the named post type's archive page -->
